...
#
# SHELL SCRIPT FOR RUNNING QUANTISNP 2 - sample 1
#
...
echo "SAMPLE 1 CALLING END"

#
# SHELL SCRIPT FOR RUNNING QUANTISNP 2 - sample 2
#
...
set SAMPLEID 		= 99HI0698C										        	# sample name
# set GENDER 			= female									            # sample gender
set INFILE 			= /users/zhe/GEARS_CNV/quantisnp/INPUT/sample2.txt	        # input data file
...
echo "SAMPLE 2 CALLING END"

#
# SHELL SCRIPT FOR RUNNING QUANTISNP 2 - sample 3
#
...
set SAMPLEID 		= 99HI0700A										        	# sample name
# set GENDER 			= female									            # sample gender
set INFILE 			= /users/zhe/GEARS_CNV/quantisnp/INPUT/sample3.txt	        # input data file
